...
switch ($str) {
    ...
    case 'tech':
        $res = '["Full-stack programmer", "Architecture, Front-end, Back-end, Coding, UX, UI", "PHP [Doctrine], JS [jQuery, React, AJAX], MySQL, Python, CSS, HTML", "GIT, VScode, Wakatime", "RPi, Linux, server setup, ISP, PayGates", "", "DOP, CO, 1st AC, 2nd AC, Grader", "ARRI, RED, BM, SONY, AATON 35mm, Bolex 16mm", "Adobe: Pr, AEf, Ps, Lr, Ai, Id", "", "Hotline Miami (A+)"]';
    break;
