...
$(document).ready(function() {
    $(window).load(function() {
        ...
        $("#listener").keyup(function() {
            ...
            if (read.match(/(tech)/)) {writeme('fullstack, frontend, backend, coding, architecture, ux, ui<br>› PHP, JS (+react, +jq, +ajax), CSS, HTML, MySQL<br>› GIT, Atom<br>›<br>› DoP, 1st AC, 2nd AC, grader<br>› DIGITAL: RED, BM (URSA, PC), SONY FS (5, 7), Atomos, Ronin, MOVI<br>› ANALOG: AATON, Bolex, Krasnogorsk<br>› <br>› Adobe: Premiere, After Effects, Photoshop, Lightroom<br>› DaVinci Resolve<br>›<br>› Hotline Miami (A+)');} else
